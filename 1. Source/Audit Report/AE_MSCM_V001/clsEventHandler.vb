                        ...
                        Case "GST"
                            If pVal.EventType = SAPbouiCOM.BoEventTypes.et_ITEM_PRESSED Then
                                ...
                                ElseIf pVal.ItemUID = "btnGenerat" Then
                                    ...
                                    If GSTAuditFile(oForm.Items.Item("txtFrmDate").Specific.string, oForm.Items.Item("txtToDate").Specific.string, oForm.Items.Item("11").Specific.string, p_oDICompany, sPath, sErrDesc) <> RTN_SUCCESS Then Throw New ArgumentException(sErrDesc)
