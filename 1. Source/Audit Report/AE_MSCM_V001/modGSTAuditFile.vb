...
Namespace AE_MSCM_V001
    ...
    Module modGSTAuditFile
        ...
        Function GSTAuditFile(ByVal dtFromDate As String, ByVal dtToDate As String, ByVal etGST As String, ByVal oCompany As SAPbobsCOM.Company, ByVal spath As String, ByRef sErrDesc As String) As Long
            ...
            Try
                ...
                sQueryString = "EXEC AE_SP001_AuditFileReport '" & GetDate(dtFromDate, oCompany) & "','" & GetDate(dtToDate, oCompany) & "','" & etGST & "'"
        ...
        Function GenerateXMLFile(ByRef oDSAuditFile As DataSet, ByVal sFilePath As String, ByRef sErrDesc As String) As Long
            ...
            Try
                ...
                'oDSAuditFile.Tables(0).TableName = "Supply"
                'oDSAuditFile.Tables(1).TableName = "LedgerEntry"
                'oDSAuditFile.Tables(2).TableName = "Company"
                'oDSAuditFile.Tables(3).TableName = "Purchase"
                '' oDSAuditFile.Tables(4).TableName = "Footer"
                ...
                Using writer As XmlWriter = XmlWriter.Create(sFilePath, settings)
                    ...
                    For iRow As Integer = 0 To oDSAuditFile.Tables(3).Rows.Count - 1
                        ...
                        If sAcctCode <> oDSAuditFile.Tables(1).Rows(iRow)("AccountID").ToString() And iRow <> 0 Then
                        ...
                        sAcctCode = oDSAuditFile.Tables(1).Rows(iRow)("AccountID").ToString()
