    ...
    Module modCommon
        ...
        Public Function Set_Conditions(ByRef oform As SAPbouiCOM.Form, ByRef sErrDesc As String) As Long
            ...
            Try
                ...
                Dim oCombo As SAPbouiCOM.ComboBox = oform.Items.Item("t_type").Specific
                Dim val1 As String = oform.Items.Item("t_type").Specific.value.ToString
                'Dim Val As String = oCombo.Selected.Value.ToString
        ...
        Public Function ExportToPDF(ByVal sCardCodeFrom As String, _
            ...
            Try
                ...
                objReport.SetParameterValue(4, sType)
                'Export to PDF
        ...
        Function Loading_AgingDetails(ByRef FormUID As SAPbouiCOM.Form, ByRef oApplication As SAPbouiCOM.Application _
            ...
            Try
                ...
                sQry = "AB_SOA_OS_SP004_01'" & FormUID.Items.Item("BPFrom").Specific.String & "','" & FormUID.Items.Item("BPTo").Specific.String & "','" & AgingDate & "','1', '" & FormUID.Items.Item("t_type").Specific.value.ToString & "'"
