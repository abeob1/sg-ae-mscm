...
Namespace AddOnInstaller
    ...
    Public Class AddOnInstallInfo
        ...
        Public Sub New()
            MyBase.New
            'INITIALIZATION CODE	...
            AddOnName = "AE_MSCM_SOA"
            PartnerName = "Abeo"
            RestartNeeded = False
            ExeFile = "AE_MSCM_V002.exe"
            UIFile = "SAPbouiCOM.dll"
            ExtraFiles = New String() {"AE_MSCM_V002.exe.config", "GSTAuditFile.srf", "SOA.srf", "SOA1.bmp", "Statement_of_Account_V2.rpt"}
